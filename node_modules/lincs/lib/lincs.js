...
var LINCS = function () {
    ...
    _bucket.connectionTimeout = 10000;
    _bucket.operationTimeout = 10000;
    _bucket.upsert("doc_numero_uno", {hope: "that this works"}, function(err, res) {
      console.log(err, res);
    });
...
LINCS.prototype.instSamePlateVehicles = function(key, cb) {
    ...
    console.log('vehicle information is:');
    console.log(v);
