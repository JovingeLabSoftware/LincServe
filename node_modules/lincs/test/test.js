...
describe('LINCS funtion tests', function () {
    ...
    describe('LINCS CRUD Functions', function () {
        ...
        it.skip('retrieves vehicle for an instance', function (done) {
		    lincs.getVehicle("1")
		    .then(function(veh) {
        ...
        it.skip('retrieves the second 100 "gold" instances for cell line A549', function (done) {
	    this.timeout(5000);
        ...
        it.skip('retrieves all related instances (same cell line, perturbation, dose, duration)', function (done) {
	    this.timeout(5000);
	  ...
	  it.skip('retrieves all vehicle instances from the same plate for a given instance', function(done) {
        ...
        it.skip('retrieves gene expression data for many keys', function (done) {
	    this.timeout(10000);
		    lincs.getData(["CPC001_HA1E_6H_X1_B3_DUO52HI53LO:C12", "BRAF001_HEK293T_24H_X1_B10:P24"], "q2norm")
		    .then(function(res) {
		    	assert(res.length  == 2);
				done();
		    })
